  ...
  return (
    <div className='px-3 py-2 grid grid-cols-2 md:flex gap-2'>
      ...
      <Select onValueChange={setBathCount}>
        ...
        <SelectContent>
          <SelectItem value="2">
            <h2 className='flex gap-2'><BathIcon className='h-5 w-5 text-primary'/> 2+</h2>
          </SelectItem>
          <SelectItem value="3">
          <h2 className='flex gap-2'><BathIcon className='h-5 w-5 text-primary'/> 3+</h2>
          </SelectItem>
          <SelectItem value="4">
          <h2 className='flex gap-2'><BathIcon className='h-5 w-5 text-primary'/> 4+</h2>
          </SelectItem>
          <SelectItem value="5">
          <h2 className='flex gap-2'><BathIcon className='h-5 w-5 text-primary'/> 5+</h2>
          </SelectItem>
        </SelectContent>
      </Select>
